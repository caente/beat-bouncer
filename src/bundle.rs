use crate::systems::{BounceSystem, MoveBallsSystem, MovePaddleSystem, PaddleSystem, WinnerSystem};
use amethyst::{
...
impl<'a, 'b> SystemBundle<'a, 'b> for PongBundle {
    fn build(
        ...
        builder.add(MovePaddleSystem, "move_paddle", &["paddle_system", "ball_system"]);
        builder.add(
            BounceSystem,
            "collision_system",
